...
\begin{figure}[h]
    \centering
    \includegraphics[width=14cm]{img/Ising_bptt/CI_l3_k3.png}
    \caption{For Ising on a bipartite graph, $l=3$, $k=3$, leaves are conditionally independent given the root node. It is true for both the $a$ star
    and the $k$ star. Note that sometimes the optimizers seem to fail to find the optimizer, and we get spikes in mutual information, but they are not
    consistent and disappear after a trial with a different seed.}
