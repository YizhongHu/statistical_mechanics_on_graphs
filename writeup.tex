...
\begin{figure}[h]
    ...
    \caption{Edward-Anderson model with edge marks $\{-2, -1, 0, 1, -2\}$ and $\kappa=2$. $\eta_Y(0)=p$, $\eta_Y(\pm 1)=q$, $\eta_Y(\pm 2)=\frac12-\frac12p-q$. The root mark distribution is independent of $B$}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{img/EA_x0_B_logi_kappa_3_3s_p=0.50.png}
    \includegraphics[width=10cm]{img/EA_x0_B_logi_kappa_4_3s_p=0.50.png}
