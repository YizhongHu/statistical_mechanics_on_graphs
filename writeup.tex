...
\begin{equation*}
    e^{2\bar{h}^ax}\left[\frac{\cosh(\beta x + \bar{h}^v)}{\cosh(\beta x - \bar{h}^v)}\right] = e^{Bx}\left[\frac{\cosh(\beta x + \bar{h}^v)}{\cosh(\beta x - \bar{h}^v)}\right]^\ell.
\end{equation*}
Thus,
\begin{align*}
