...
\begin{proposition}
    ...
    \end{equation}
    if and only if $(\pi_{\widetilde{\mu}}, \widetilde{\mu})$ is an optimizer of
...
\begin{proposition}\label{Prp.optimizer-given-pi}
    Given an admissible probability measure $\pi$ on $\mathcal{X}^2$, stationary points of the optimization problem
    \begin{equation*}
        \inf_{\substack{\widetilde{\mu}\in\mathcal{P}_{s}(\mathcal{X}\times\mathcal{X}^\kappa) \\ \pi_{\widetilde{\mu}}=\pi}} H(\mu\|\eta)
    \end{equation*}
    are in the form
    \begin{equation*}
        \frac{d\widetilde{\mu}}{d\widetilde{\eta}}(x_0, x)=\frac{d\pi^0}{d\pi_{\widetilde{\eta}}^0}(x_0) \prod_{v=1}^\kappa \frac{d\pi^0}{d\pi_{\widetilde{\eta}}^{1|0}}(x_v|x_0),
    \end{equation*}
