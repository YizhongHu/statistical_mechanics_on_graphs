...
\begin{proposition}
    ...
    \begin{equation}\label{Eq.XY-target-with-pi}
        \sup_{\pi\in\mathcal{P}_s(\mathcal{X}^2)}\left\{\mathbb{E}_\pi\left[B\cos x_0 + \frac{\beta\kappa}2\cos(x_0-x_1)\right] + \frac\kappa2 H(\pi_\mu\|\pi_\eta) - \inf_{\substack{\mu\in\mathcal{P}_{s}(\mathcal{X}\times\mathcal{X}^\kappa) \\ \pi_{\mu}=\pi}} H(\mu\|\eta)\right\}
    \end{equation}
\end{proposition}
