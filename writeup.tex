...
\begin{proof}
    ...
    \begin{align*}
        H(\widetilde{\mu} \| \widetilde{\eta}) & = \int_{\mathcal{X}\times\mathcal{X}^\kappa} \frac{d\widetilde{\mu}}{d\widetilde{\eta}}(\widetilde{\tau})\log \frac{d\widetilde{\mu}}{d\widetilde{\eta}}(\widetilde{\tau})\widetilde{\eta}(d\widetilde{\tau}) \\
                                               & = \int_{\mathcal{X}\times\mathcal{X}^\kappa} \frac{d{\mu}}{d{\eta}}(T\widetilde{\tau})\log \frac{d{\mu}}{d{\eta}}(T\widetilde{\tau})\widetilde{\eta}(d\widetilde{\tau})                                       \\
        \intertext{Making the substitution $\tau = T\widetilde{\tau}$}
...
We can therefore define admissibility on $\mathcal{P}_s(\mathcal{X}\times\mathcal{X}^\kappa)$.

\begin{proposition}
    For each $\mu\in\mathcal{P}_u\mathcal{T}^\kappa_{*, 1}[\mathcal{X}]$, there exists a unique
    $\widetilde{\mu}$ such that $\pi_{\widetilde{\mu}}$ is symmetric.
\end{proposition}

Denote the set of symmetric probability measures on $\mathcal{X}^2$, $\mathcal{P}_s(\mathcal{X}^2)$, and the set
of symmetric measures on $\mathcal{X}\times\mathcal{X}^\kappa$ that has a symmetric $\pi_{\widetilde{\mu}}$ distribution
as $\mathcal{P}_{u, s}(\mathcal{X}\times\mathcal{X}^\kappa)$.
...
\begin{definition}
    A signed measure $\eta$ on $\mathcal{X}^{\kappa+1}$ is called $\pi$-null if $\pi_\eta = 0$.
\end{definition}
