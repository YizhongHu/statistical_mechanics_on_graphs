...
\end{equation*}
In fact, assuming that the distribution is not dependent on $\beta$, $f$ should not be dependent of $\beta$.
\begin{figure}[h]
    \centering
    \includegraphics[width=12cm]{img/EA_x0_B_logisitic.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=12cm]{img/EA_x0_B_logisitic_change_kappa.png}
    \caption{For Edward-Anderson model with $\kappa=2, 3, 4, 5, 6$, we see that the root mark distribution is roughly the same. }
