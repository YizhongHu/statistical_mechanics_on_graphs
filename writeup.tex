...
\begin{proof}
    ...
    %             \filldraw[black] (-2, -1) circle(3pt);
    %             \filldraw[black] (-2.5, -3) circle(3pt);
    %             \filldraw[black] (-1.5, -3) circle(3pt);
    %             \filldraw[black] (-0.5, -3) circle(3pt);
    %             \filldraw[black] (0.5, -3) circle(3pt);
    %             \filldraw[black] (1.5, -3) circle(3pt);
    %             \filldraw[black] (2.5, -3) circle(3pt);
    ...
    %             \draw [black, thick] (0,0)--(-2,-1);
    %             \draw [black, thick] (-2,-1)--(-2.5,-3);
    %             \draw [black, thick] (-2,-1)--(-1.5,-3);
    %             \draw [black, thick] (0,-1)--(-0.5,-3);
    %             \draw [black, thick] (0,-1)--(0.5,-3);
    %             \draw [black, thick] (2,-1)--(1.5,-3)
    %             \draw [black, thick] (2,-1)--(2.5,-3);

    %             \draw [black, thick, dashed] (-0.25, 0.5)--(-0.25,-1.25)--(3,-1.25)--(-0.25, 0.5);
    %             \node
    %             \draw [black, thick, dashed] (-2, -0.25)--(-3, -3.25)--(-1,-3.25)--(-2, -0.25);
    %         \end{tikzpicture}
    %     \end{center}
    % \end{figure}
\end{proof}
...
\begin{proof}
    ...
    \end{align*}
    \footnotetext{This step is problematic...}
